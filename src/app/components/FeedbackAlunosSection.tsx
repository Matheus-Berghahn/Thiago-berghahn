...
export default function Carousel() {
  ...
  return (
    <div className="w-full bg-cinza flex justify-center items-center flex-col relative pb-20 ">
      ...
      <div className="w-full h-[100px] absolute bg-white z-[100] top-0 rounded-b-3xl "></div>
      ...
      {/* <motion.h2
          ...
          className="text-2xl md:text-3xl font-bold text-center text-red-700  py-5 px-5 md:py-10 md:px-10 mt-16 md:mt-12 "
        >
        Resultados
      </motion.h2> */}
