  ...
  return (
    <header className="relative flex flex-col xl:flex-row items-center justify-center xl:gap-60 px-5 xl:px-10 pt-10 mx-auto overflow-hidden z-[130]">
      ...
      <button
        ...
        className=" px-6 py-2 rounded-lg border-2 md:mb-4 md:mr-8 xl:mb-4 xl:mr-8 mb-0 border-red-700 bg-cinza text-white font-medium mt-4 transition-colors duration-300 hover:bg-red-700 hover:text-black shadow-lg shadow-neutral-800"
      >
        {isOpen ? "x" : "Contato"}
      </button>
      ...
      {isOpen && (
        <div className="mt-3 flex flex-col items-end space-y-2 xl:mr-8">
          <motion.a
            ...
            className="px-6 py-3 rounded-lg border-red-700 border-2 bg-cinza text-red-700  shadow-lg cursor-pointer shadow-neutral-800"
      ...
      <motion.div className="absolute w-full h-full top-0 left-0 hidden xl:block"
        ...
        <motion.div
          className="absolute top-[-20%] right-[-12%] h-[140%] w-[42%] bg-red-700 anim_shape_01  anim_shape opacity-0 rounded-lg"
      ...
      <div className=" z-10 flex flex-col ">
        ...
        <motion.button
          className="xl:w-2/6 px-6 py-2 rounded-lg border-2 xl:mb-0 mb-10 border-red-700 text-white font-medium mt-4 transition-colors duration-300 hover:bg-red-700 hover:text-black"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
