...
const AcompanhamentoSection = () => {
  ...
  return (
    <div className="relative w-full py-20 md:pb-48 md:py-40 bg-white flex items-center justify-center px-5 md:px-0 shadow-[0px_10px_30px_rgba(0,0,0,0.8)] z-50 rounded-t-3xl">
